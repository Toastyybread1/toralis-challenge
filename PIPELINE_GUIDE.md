...
> Detailed pipeline guide retained from main. Use [README.md](README.md) for
> the combined Slicer setup. Both tracing paths now share validation, and peak
> memory reporting also supports Windows. Current results are recorded in
